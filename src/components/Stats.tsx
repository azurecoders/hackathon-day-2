...
const Stats = () => {
  return (
    <>
      <section className="bg-background text-text border-b border-[#ccc]/10">
        <div className="text-text max-w-7xl py-10 lg:py-14 mx-auto">
            ...
            <div className="lg:col-span-5 lg:col-start-1">
              <div className="mb-8">
                <h2 className="mb-2 text-3xl text-gray-800 font-bold lg:text-4xl dark:text-neutral-200">
                  It's all about{" "}
                  <span className="text-shadows font-extrabold">speed</span>
                </h2>
